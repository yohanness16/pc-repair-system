...
from .views import RegisterView ,LogoutView , UpdateProfileView , MyTokenObtainPairView , PingView, ForgotPasswordView , RequestPasswordResetView, VerifyResetCodeView , StaffListView , StaffRepairProgressView
